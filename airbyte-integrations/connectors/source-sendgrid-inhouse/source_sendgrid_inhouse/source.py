...
class SourceSendgridInhouse(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        streams = [
            ...
            CategoriesStat(authenticator=authenticator, start_date=start_time),
            Stats(authenticator=authenticator, start_date=start_time)
        ]
