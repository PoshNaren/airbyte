...
public class InhouseJdbcBufferedConsumerFactory{

  private static final Logger LOGGER = LoggerFactory.getLogger(InhouseJdbcBufferedConsumerFactory.class);
  ...
  private static RecordWriter<AirbyteRecordMessage> recordWriterFunction(final JdbcDatabase database,
    ...
    final Map<AirbyteStreamNameNamespacePair, WriteConfig> pairToWriteConfig = writeConfigs.stream()
        .collect(Collectors.toUnmodifiableMap(InhouseJdbcBufferedConsumerFactory::toNameNamespacePair, Function.identity()));
